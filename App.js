...
function ContatoScreen({ navigation }) {
  const contatos = [
    ...
    {
      id: 2,
      nome: "Ishmael Talicious fish",
      numero: "81 9 23456678",
      email: "IshmaelLimbus@gmail.com",
    },
    {
      id: 3,
      nome: "Natalia Bernand Fonseca",
      numero: "81 9 33344455",
          ...
          <View horizontal style={styles.item}>
            <View style={styles.row}>
              ...
              <View style={{ marginLeft: 15 }}>
                <Text style={styles.text1}>{contato.nome}</Text>
                <Text style={styles.text1}>{contato.numero}</Text>
              </View>
            </View>
          </View>
        </TouchableOpacity>
